...
namespace ChildCentre.Controllers
{
    ...
    {
        RepoAccount accountRepo = new RepoAccount();
        ...
        {           
            ...
            {
                if (!accountRepo.UserExists(model.UserName))
                {
                    try
                    {
                        WebSecurity.CreateUserAndAccount(model.UserName, model.Password);

                        var NewUser = new Guardian
                        {
                ...
                else ModelState.AddModelError("", "Username already exists. Please choose a different one");
            }
        ...
        {
            var user = accountRepo.GetUserProfile();
            return View(user);
        }
        ...
        public ActionResult ChangeProfile(ProfileModel profile)
        {
            if (ModelState.IsValid)
            {
                accountRepo.UpdateProfile(profile);
